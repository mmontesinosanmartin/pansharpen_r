# see more info at: http://www.saga-gis.org/saga_tool_doc/2.2.1/imagery_tools_4.html
pansharpen_ihs <- function(saga.path,
                           ms.img,
                           pan.img,
                           r = 1, g = 2, b = 3,
                           resampling = "cubic",
                           ...
                           verbose = FALSE)
{
  ...
  writeRaster(pan.img, tmp.pan, overwrite = TRUE)
