...
Minimum requirement to follow this tutorial: install [`RStoolbox`
](http://bleutner.github.io/RStoolbox/)(Leutner et al., 2019) to
pansharpen and `tmap` (Tennekes, 2018) to visualize the results:
